...
function Specs({ img, heading, para }) {
    return (
        <div className="items grid grid-rows-[max-content_max-content] ">
            <div className=" row-start-1 row-end-2  justify-center flex">
                <img src={`${img}`} alt="img" />
            </div>
            <div className="row-start-2 row-end-3 data grid grid-rows-[max-content_max-content] gap-2">
                <h2 className="text-center font-[700] text-[#f67e7f] md:text-left">{heading}</h2>
...
export default function Section1() {
    return (<div className="section1 bg-[#022f34] text-white grid grid-cols-[24px_1fr_24px] md:grid-cols-[1fr_1110px_1fr] ">

        <div className="col-start-2 col-end-3 |=>  grid grid-cols-9 md:gap-x-5 grid-rows-[100px_max-content_max-content_52px] ">
