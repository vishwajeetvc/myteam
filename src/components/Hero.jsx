    ...
    return (
        <div
            ...
            < div
               ...
               sm:bg-[100%_100%] sm:grid-cols-12 sm:grid-rows-[56px_auto_56px_194px]  sm:gap-x-0  md:gap-5 sm:gap-y-0 max-w-[1110px] sm:m-auto
            `} >
                ...
                <div
                    className={`row-start-3 text-white  text-center row-end-4 font-[500] leading-6 text-[16px]
                            ...
                            sm:before:block before:relative mt-4 sm:mt-0  before:w-14 before:h-1 before:bg-sky-300 before:top-[-68px]
                        `}>
